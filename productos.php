...
// Obtener empresas del usuario para selección
$sql_empresas = "SELECT id, nombre FROM empresas WHERE usuario_id = $usuario_id";
$result_empresas = $mysqli->query($sql_empresas);

// Insertar nuevo producto
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_POST['nombre_producto'])) {
    ...
    $sql = "INSERT INTO productos (empresa_id, nombre, descripcion, precio, stock) 
            VALUES ($empresa_id, '$nombre_producto', '$descripcion', $precio, $stock)";
    $mysqli->query($sql);
    header("Location: productos.php");
    exit();
}

// Obtener productos del usuario (solo de sus empresas)
...
<head>
<meta charset="UTF-8" />
<title>Productos - Sistema Paccioli</title>
<style>
body {
    margin: 0;
...
<div class="container">
    <div class="inner-content">
        ...
        <table>
            <thead>
                <tr>
                    <th>Empresa</th><th>Nombre</th><th>Descripción</th><th>Precio</th><th>Stock</th>
                </tr>
            </thead>
            <tbody>
