...
--
-- Host: localhost    Database: inventario_paccioli
-- ------------------------------------------------------
...
CREATE TABLE `calificaciones` (
  ...
  CONSTRAINT `calificaciones_ibfk_1` FOREIGN KEY (`empresa_id`) REFERENCES `empresas` (`id`) ON DELETE CASCADE,
  CONSTRAINT `calificaciones_ibfk_2` FOREIGN KEY (`docente_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2025-08-21 20:09:38
